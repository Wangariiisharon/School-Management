    ...
    <div class="container-fluid mt-4 " id="create-form">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://www.un.org/sites/un2.un.org/files/styles/large-article-image-style-16-9/public/field/image/2022/08/vanuato-17.jpg?itok=cKTxbRmk" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Enter the new Stu</h5>
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <input type="submit" class="bttn-save" value="Save">
                            <input type="reset" class="bttn-update" value="Reset">
    ...
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShFrwBwpZaScU3EpaC4k_2al3BrS-eL6EpFdQ6Cpcqs1ZVa-jNJeGy0F1x0tY3rL5xis4&usqp=CAU" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <input type="submit" class="bttn-update" value="Update">
